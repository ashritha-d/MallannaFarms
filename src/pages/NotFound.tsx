  ...
  return (
    <>
      ...
      <section className="relative flex min-h-[70vh] items-center justify-center overflow-hidden">
        <img src={FARM_IMAGES.henCloseup} alt="" aria-hidden="true" className="absolute inset-0 h-full w-full object-cover" />
        ...
        <div className="container-page relative z-10 text-center text-cream-50">
          ...
          <h1 className="mt-4 font-display text-2xl font-semibold text-cream-50 sm:text-3xl">This page has wandered off the farm</h1>
